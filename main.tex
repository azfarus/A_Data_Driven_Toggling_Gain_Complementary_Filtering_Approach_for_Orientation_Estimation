...
\begin{itemize}
    ...
    \label{tab:sensor_readings}
        ...
        \end{adjustbox}
    \end{table}
    After forming X and y the datasets were split to train and test sets with train set having 80\% of the split.


    \item As mentioned in \autoref{subsec:choice_of_model}, we use the XGBoost Classifier model to predict movement.
    ...
    \item After running the Optuna Study for \texttt{N=100} iterations, the best hyperparameters were chosen and 
