...
The algorithm is represented through the flow diagram in \autoref{Filter Diagram} 

\begin{figure}
    \centering
    \includesvg[width=0.8\linewidth]{figures/filter_diagram.svg}
    \caption{Filter Diagram\footnotemark{} for our proposed Data Driven Toggling Gain CF.}
